...
SECRET_KEY = 'django-insecure-aau&+7w7q$cu8krny%j4p0+pmk(hk!m_3ulpgfivs(-u42les4'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['Enz-48.pythonanywhere.com',
                 ]
...
# Email / OTP settings
# For classroom testing, OTP is also printed in the terminal.
# To send real Gmail OTPs, set these environment variables before running the server:
